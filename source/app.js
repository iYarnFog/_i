parcelRequire = function(e, r, t, n) {
    ...
    "XR92": [function(require, module, exports) {
        ...
        !function(e, n) {
            ...
            var e, n = function() {
                var e, n, r, i, o, a, s = [], u = s.concat, c = s.filter, l = s.slice, f = t.document, h = {}, p = {}, d = {
                    "column-count": 1,
                    columns: 1,
                    "font-weight": 1,
                    "line-height": 1,
                    ...
                    "z-index": 1,
                    zoom: 1
                }, m = /^\s*<(\w+|!)[^>]*>/, v = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, g = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, y = /^(?:body|html)$/i, x = /([A-Z])/g, b = ["val", "css", "html", "text", "data", "width", "height", "offset"], E = f.createElement("table"), j = f.createElement("tr"), T = {
                    ...
                    th: j,
                    "*": f.createElement("div")
                }, w = /complete|loaded|interactive/, S = /^[\w-]*$/, C = {}, N = C.toString, O = {}, P = f.createElement("div"), A = {
                    tabindex: "tabIndex",
                    readonly: "readOnly",
                    for: "htmlFor",
                    class: "className",
                ...
                return O.matches = function(t, e) {
                    ...
                    return o && (i = P).appendChild(t),
                    r = ~O.qsa(i, e).indexOf(t),
                    o && P.removeChild(t),
                    r
                }
                ,
                ...
                O.fragment = function(t, n, i) {
                    var o, a, s;
                    return v.test(t) && (o = r(f.createElement(RegExp.$1))),
                    o || (t.replace && (t = t.replace(g, "<$1></$2>")),
                    n === e && (n = m.test(t) && RegExp.$1),
                    n in T || (n = "*"),
                    (s = T[n]).innerHTML = "" + t,
                    o = r.each(l.call(s.childNodes), function() {
                        s.removeChild(this)
                    })),
                    R(i) && (a = r(o),
                ...
                O.init = function(t, n) {
                    ...
                    if ("string" == typeof t)
                        ...
                        if (D(t))
                            ...
                            i = O.fragment(t.trim(), RegExp.$1, n),
                            t = null;
                        else {
                            if (n !== e)
                                return r(n).find(t);
                ...
                (r = function(t, e) {
                    ...
                    return "boolean" == typeof t && (r = t,
                    t = i.shift()),
                    i.forEach(function(i) {
                        !function t(r, i, o) {
                            for (n in i)
                                o && (R(i[n]) || D(i[n])) ? (R(i[n]) && !R(r[n]) && (r[n] = {}),
                                D(i[n]) && !D(r[n]) && (r[n] = []),
                                t(r[n], i[n], o)) : i[n] !== e && (r[n] = i[n])
                        }(t, i, r)
                    }),
                    t
                }
                ...
                r.fn = {
                    ...
                    closest: function(t, e) {
                        ...
                        return this.each(function(r, o) {
                            for (; o && !(i ? i.indexOf(o) >= 0 : O.matches(o, t)); )
                                o = o !== e && !k(o) && o.parentNode;
                    ...
                    parents: function(t) {
                        for (var e = [], n = this; n.length > 0; )
                            n = r.map(n, function(t) {
                                if ((t = t.parentNode) && !k(t) && e.indexOf(t) < 0)
                                    return e.push(t),
                                    t
                            });
                        return _(e, t)
                        ...
                        return "string" != typeof t || 1 in arguments ? this.each(function(e) {
                            if (1 === this.nodeType)
                                if (M(t))
                                    ...
                                    U(this, t, B(this, r, e, this.getAttribute(t)))
                    ...
                    css: function(t, e) {
                        ...
                        var u = "";
                        if ("string" == L(t))
                            e || 0 === e ? u = z(t) + ":" + H(t, e) : this.each(function() {
                                this.style.removeProperty(z(t))
                            });
                        else
                            for (n in t)
                                t[n] || 0 === t[n] ? u += z(n) + ":" + H(n, t[n]) + ";" : this.each(function() {
                        ...
                        return this.each(function(n) {
                            if ("className"in this) {
                                if (t === e)
                                    return X(this, "");
                                i = X(this),
                                B(this, t, n, i).split(/\s+/g).forEach(function(t) {
                                    i = i.replace(q(t), " ")
                                }),
                                X(this, i.trim())
                            }
                    ...
                    offsetParent: function() {
                        return this.map(function() {
                            for (var t = this.offsetParent || f.body; t && !y.test(t.nodeName) && "static" == r(t).css("position"); )
                                t = t.offsetParent;
                            return t
                        })
                    }
                ...
                O.Z.prototype = V.prototype = r.fn,
                O.uniq = a,
                O.deserializeValue = J,
                r.zepto = O,
                r
            }();
            return t.Zepto = n,
            void 0 === t.$ && (t.$ = n),
            function(e) {
                var n, r = 1, i = Array.prototype.slice, o = e.isFunction, a = function(t) {
                    return "string" == typeof t
                }, s = {}, u = {}, c = "onfocusin"in t, l = {
                    focus: "focusin",
                    blur: "focusout"
                }, f = {
                ...
                function g(t, r, i, o, a, u, c) {
                    ...
                    r.split(/\s/).forEach(function(r) {
                        ...
                        s.i = p.length,
                        p.push(s),
                        "addEventListener"in t && t.addEventListener(v(s.e), s.proxy, m(s, c))
                    })
                }
                function y(t, e, n, r, i) {
                    ...
                    (e || "").split(/\s/).forEach(function(e) {
                        p(t, e, n, r).forEach(function(e) {
                            delete s[o][e.i],
                            "removeEventListener"in t && t.removeEventListener(v(e.e), e.proxy, m(e, i))
                        })
                    })
                }
                ...
                function T(t, r) {
                    return !r && t.isDefaultPrevented || (r || (r = t),
                    e.each(j, function(e, n) {
                        var i = r[e];
                        t[e] = function() {
                            return this[n] = x,
                    ...
                    (r.defaultPrevented !== n ? r.defaultPrevented : "returnValue"in r ? !1 === r.returnValue : r.getPreventDefault && r.getPreventDefault()) && (t.isDefaultPrevented = x)),
                    t
                }
                function w(t) {
                    var e, r = {
                ...
                e.fn.trigger = function(t, n) {
                    return (t = a(t) || e.isPlainObject(t) ? e.Event(t) : T(t))._args = n,
                    this.each(function() {
            ...
            function(e) {
                var n, r, i = +new Date, o = t.document, a = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, s = /^(?:text|application)\/javascript/i, u = /^(?:text|application)\/xml/i, c = "application/json", l = "text/html", f = /^\s*$/, h = o.createElement("a");
                function p(t, n, r, i) {
                    if (t.global)
                ...
                e.ajaxJSONP = function(n, r) {
                    if (!("type"in n))
                        return e.ajax(n);
                    var a, s, u = n.jsonpCallback, c = (e.isFunction(u) ? u() : u) || "Zepto" + i++, l = o.createElement("script"), f = t[c], h = function(t) {
                        e(l).triggerHandler("error", t || "abort")
                    }, p = {
                        abort: h
                    };
                    return r && r.promise(p),
                    e(l).on("load error", function(i, o) {
                        clearTimeout(s),
                        e(l).off().remove(),
                        "error" != i.type && a ? m(a[0], p, n, r) : v(null, o || "error", p, n, r),
                        t[c] = f,
                        a && e.isFunction(f) && f(a[0]),
                        f = a = void 0
                    }),
                    !1 === d(p, n) ? (h("abort"),
                    p) : (t[c] = function() {
                ...
                e.ajax = function(i) {
                    var a, g, b = e.extend({}, i || {}), E = e.Deferred && e.Deferred();
                    for (n in e.ajaxSettings)
                        void 0 === b[n] && (b[n] = e.ajaxSettings[n]);
                    !function(t) {
                        t.global && 0 == e.active++ && p(t, null, "ajaxStart")
                    }(b),
                    b.crossDomain || ((a = o.createElement("a")).href = b.url,
                    a.href = a.href,
                    b.crossDomain = h.protocol + "//" + h.host != a.protocol + "//" + a.host),
                    b.url || (b.url = t.location.toString()),
                    (g = b.url.indexOf("#")) > -1 && (b.url = b.url.slice(0, g)),
                    function(t) {
                        t.processData && t.data && "string" != e.type(t.data) && (t.data = e.param(t.data, t.traditional)),
                        !t.data || t.type && "GET" != t.type.toUpperCase() && "jsonp" != t.dataType || (t.url = x(t.url, t.data),
                        t.data = void 0)
                    }(b);
                    var j = b.dataType
                      , T = /\?.+=\?/.test(b.url);
                    if (T && (j = "jsonp"),
                    !1 !== b.cache && (i && !0 === i.cache || "script" != j && "jsonp" != j) || (b.url = x(b.url, "_=" + Date.now())),
                    "jsonp" == j)
                        return T || (b.url = x(b.url, b.jsonp ? b.jsonp + "=?" : !1 === b.jsonp ? "" : "callback=?")),
                        e.ajaxJSONP(b, E);
                    var w, S = b.accepts[j], C = {}, N = function(t, e) {
                        C[t.toLowerCase()] = [t, e]
                    }, O = /^([\w-]+:)\/\//.test(b.url) ? RegExp.$1 : t.location.protocol, P = b.xhr(), A = P.setRequestHeader;
                    if (E && E.promise(P),
                    b.crossDomain || N("X-Requested-With", "XMLHttpRequest"),
                    N("Accept", S || "*/*"),
                    (S = b.mimeType || S) && (S.indexOf(",") > -1 && (S = S.split(",", 2)[0]),
                    P.overrideMimeType && P.overrideMimeType(S)),
                    (b.contentType || !1 !== b.contentType && b.data && "GET" != b.type.toUpperCase()) && N("Content-Type", b.contentType || "application/x-www-form-urlencoded"),
                    b.headers)
                        for (r in b.headers)
                            N(r, b.headers[r]);
                    if (P.setRequestHeader = N,
                    P.onreadystatechange = function() {
                        if (4 == P.readyState) {
                            ...
                            if (P.status >= 200 && P.status < 300 || 304 == P.status || 0 == P.status && "file:" == O) {
                                if (j = j || ((r = b.mimeType || P.getResponseHeader("content-type")) && (r = r.split(";", 2)[0]),
                                r && (r == l ? "html" : r == c ? "json" : s.test(r) ? "script" : u.test(r) && "xml") || "text"),
                                "arraybuffer" == P.responseType || "blob" == P.responseType)
                                    ...
                                    try {
                                        ...
                                        "script" == j ? (0,
                                        eval)(t) : "xml" == j ? t = P.responseXML : "json" == j && (t = f.test(t) ? null : e.parseJSON(t))
                                    } catch (i) {
                                        n = i
                                    }
                                    if (n)
                                        return v(n, "parsererror", P, b, E)
                                }
                                m(t, P, b, E)
                            } else
                                v(P.statusText || null, P.status ? "error" : "abort", P, b, E)
                        }
                        var r
                    }
                    ,
                    ...
                    if (P.open(b.type, b.url, D, b.username, b.password),
                    b.xhrFields)
                    ...
                    return b.timeout > 0 && (w = setTimeout(function() {
                        P.onreadystatechange = y,
                        P.abort(),
                        v(null, "timeout", P, b, E)
                    }, b.timeout)),
                    P.send(b.data ? b.data : null),
                    P
                }
                ,
                e.get = function() {
                ...
                e.fn.load = function(t, n, r) {
                    if (!this.length)
                        return this;
                    var i, o = this, s = t.split(/\s/), u = b(t, n, r), c = u.success;
                    return s.length > 1 && (u.url = s[0],
                    i = s[1]),
                ...
                e.param = function(t, n) {
                    ...
                    ,
                    function t(n, r, i, o) {
                        var a, s = e.isArray(r), u = e.isPlainObject(r);
                        e.each(r, function(r, c) {
                            a = e.type(c),
                            o && (r = i ? o : o + "[" + (u || "object" == a || "array" == a ? r : "") + "]"),
                            !o && s ? n.add(c.name, c.value) : "array" == a || !i && "object" == a ? t(n, c, i, r) : n.add(r, c)
                        })
                    }(r, t, n),
                    r.join("&").replace(/%20/g, "+")
                }
    ...
    "Bb20": [function(require, module, exports) {
        ...
        var t = require("zepto").$;
        function e() {
            var e = ["希望能成为有趣的人", "给时光以生命<br>给岁月以文明", "你好，请多指教", "当你在凝视着网页的时候<br>网页也正在凝视着你", "苟……", "ご注文はねこですか？", "平凡的日常正奇迹的发生着", "Lata<br>lulila<br>lulula<br>lulalila ♪♫", "ただの人間には<br>興味ありません！", "さあ、ゲームを始めよう", "搞事！搞事！搞事！", "敬畏之心！", "赞美之心！", "我很好奇！", "欢迎大家光临星象馆<br>这里有着无论何时永远不会消失<br>美丽的无穷光辉<br>满天的星星等候着大家的到来", "*舒缓的现代音乐*"]
              , i = o(0, e.length - 1);
            t("#slogan").html(e[i]);
            fetch('https://v1.hitokoto.cn/')
              .then(response => response.json())
              .then(ydata => {
                //t("#slogan").html('『' + ydata['hitokoto'] + '』');
                t("#slogan").html(ydata['hitokoto']);
                t('.yfrom').html('-「' + ydata['from'] + '」');
              });
        }
        function o(t, e) {
            var o = e - t
        ...
        ,
        t(function() {
            var t, e, o = document.createElement("canvas"), i = document.getElementById("startrack");
            ...
            function w() {
                u(),
                ++c > 150 && c % 8 == 0 && (a.fillStyle = "rgba(0,0,0,.04)",
            ...
            !function() {
                for (var t = d.length; t--; ) {
                    var e = d[t];
                    r.beginPath(),
                    r.arc(e.x, e.y, e.size, 0, 2 * Math.PI, !0),
                    r.fillStyle = e.color,
                    r.closePath(),
                    r.fill()
                }
        ...
        t(function() {
            e(),
            console.log("%c %c纸伞下的烟雨", "background:url('https:afdian.net/static/img/logo/logo.png') no-repeat;background-size:cover;padding: 7px 10px;margin-right:8px", "color:rgba(148,108,230,1);text-shadow: 0 1px 1px #bbb;font-size:16px"),
            console.log("赞助一下：%chttps://afdian.net/@afdian", "color:rgba(148,108,230,1)")         
        });
    }
    , {
        "zepto": "XR92"
